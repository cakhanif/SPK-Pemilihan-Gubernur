...
<!-- 		        <tfoot>
		...
		?>
		            <tr>
		                ...
		                <td class="text-center">
							<a href="rangking-ubah.php?ia=<?php echo $row['id_kandidat'] ?>&ik=<?php echo $row['id_kriteria'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
							<a href="rangking-hapus.php?ia=<?php echo $row['id_kandidat'] ?>&ik=<?php echo $row['id_kriteria'] ?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
					    </td>
		            </tr>
		<?php
		}
		...
		?>
		            <tr>
		                <th><?php echo $row1['nama_kandidat'] ?></th>
		                <?php
		                $a= $row1['id_kandidat'];
						$stmtr = $pro->readR($a);
